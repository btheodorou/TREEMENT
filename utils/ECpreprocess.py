...
trial_list = pickle.load(open('../data/trial_list','rb'))
err_list = []
...
for each_trial in trial_list:
  each_trial['inclusion'] = each_trial['inclusion'].replace('\r','')
  each_trial['inclusion'] = each_trial['inclusion'].replace('             ',' ')
...
for each_trial in trial_list:
  each_trial['exclusion'] = each_trial['exclusion'].replace('\r','')
  each_trial['exclusion'] = each_trial['exclusion'].replace('             ',' ')
...
faulty_exclusion_parsing = [208, 410, 558]
for t in faulty_exclusion_parsing:
  trial_list[t]['exclusion_list'] = []
        
pickle.dump(trial_list, open('../data/clean_list','wb'))