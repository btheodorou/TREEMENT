...
ehr_data = pd.read_csv('../data/records.csv', dtype={'claim_id':str})
proc_dict = pickle.load(open('../data/proc_dict','rb'))
diag_dict = pickle.load(open('../data/diag_dict','rb'))
prod_dict = pickle.load(open('../data/prod_dict','rb'))
...
pickle.dump(diag_dataset,open('../data/diag_dataset', 'wb'))
pickle.dump(prod_dataset,open('../data/prod_dataset', 'wb'))
pickle.dump(proc_dataset,open('../data/proc_dataset', 'wb'))
...
pickle.dump(test_ehr_dataset,open('../data/test_ehr_dataset', 'wb'))
pickle.dump(test_demo_dataset,open('../data/test_demo_dataset', 'wb'))
pickle.dump(test_trial_dataset,open('../data/test_trial_dataset', 'wb'))
pickle.dump(test_id_dataset,open('../data/test_id_dataset', 'wb'))
pickle.dump(test_label_dataset,open('../data/test_label_dataset', 'wb'))


for i in tqdm(range(len(valid_idx))):
  cur_idx = valid_idx[i]
  cur_data = ehr_data.loc[ehr_data['claim_id'] == total_claims[cur_idx]]
  initial_flag = True
  for idx, row in cur_data.iterrows():
...
pickle.dump(valid_ehr_dataset,open('../data/valid_ehr_dataset', 'wb'))
pickle.dump(valid_demo_dataset,open('../data/valid_demo_dataset', 'wb'))
pickle.dump(valid_trial_dataset,open('../data/valid_trial_dataset', 'wb'))
pickle.dump(valid_id_dataset,open('../data/valid_id_dataset', 'wb'))
pickle.dump(valid_label_dataset,open('../data/valid_label_dataset', 'wb'))
...
pickle.dump(train_ehr_dataset,open('../data/train_ehr_dataset', 'wb'))
pickle.dump(train_demo_dataset,open('../data/train_demo_dataset', 'wb'))
pickle.dump(train_trial_dataset,open('../data/train_trial_dataset', 'wb'))
pickle.dump(train_id_dataset,open('../data/train_id_dataset', 'wb'))
pickle.dump(train_label_dataset,open('../data/train_label_dataset', 'wb'))